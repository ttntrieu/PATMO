program test
  ...
  implicit none
  real*8::dt,x(speciesNumber),t,tend,tout,imass
  ...
  do
     ...
     call computeWetDep(patmo_idx_CHOCHO, 5.0d5, .FALSE.)
     ...
     !if(t==tend .or. abs(convergence) < 1d-10) then
       ...
       call patmo_dumpDensityToFile(31, t, patmo_idx_H)
       ...
       call patmo_dumpDensityToFile(36, t, patmo_idx_NH3)
       ...
       call patmo_dumpDensityToFile(42, t, patmo_idx_CH3OH)
       ...
       call patmo_dumpDensityToFile(48, t, patmo_idx_CH3CO)
       call patmo_dumpDensityToFile(49, t, patmo_idx_H2S)
       call patmo_dumpDensityToFile(50, t, patmo_idx_COCOOH)
       ...
       call patmo_dumpDensityToFile(60, t, patmo_idx_HCO)
       call patmo_dumpDensityToFile(61, t, patmo_idx_N2)
       ...
       call patmo_dumpDensityToFile(68, t, patmo_idx_H2)
       call patmo_dumpDensityToFile(69, t, patmo_idx_NH2)
       call patmo_dumpDensityToFile(70, t, patmo_idx_NH)
       call patmo_dumpDensityToFile(71, t, patmo_idx_HCN)
       ...
       call patmo_dumpDensityToFile(75, t, patmo_idx_CHOCHO)
     endif
  ...
  call computeWetDep(patmo_idx_CHOCHO, 5.0d5, .TRUE.)
